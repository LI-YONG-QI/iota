...
<pre><code><b>public</b> <b>fun</b> newT(pub: &<a href="../iota/package.md#iota_package_Publisher">iota::package::Publisher</a>, ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): <a href="../iota/display.md#iota_display_Display">iota::display::Display</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> create_and_keepT(pub: &<a href="../iota/package.md#iota_package_Publisher">iota::package::Publisher</a>, ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> update_versionT(<a href="../iota/display.md#iota_display">display</a>: &<b>mut</b> <a href="../iota/display.md#iota_display_Display">iota::display::Display</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> addT(self: &<b>mut</b> <a href="../iota/display.md#iota_display_Display">iota::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> editT(self: &<b>mut</b> <a href="../iota/display.md#iota_display_Display">iota::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code><b>public</b> <b>entry</b> <b>fun</b> removeT(self: &<b>mut</b> <a href="../iota/display.md#iota_display_Display">iota::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> is_authorizedT(pub: &<a href="../iota/package.md#iota_package_Publisher">iota::package::Publisher</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> versionT(d: &<a href="../iota/display.md#iota_display_Display">iota::display::Display</a>&lt;T&gt;): u16
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> fieldsT(d: &<a href="../iota/display.md#iota_display_Display">iota::display::Display</a>&lt;T&gt;): &<a href="../iota/vec_map.md#iota_vec_map_VecMap">iota::vec_map::VecMap</a>&lt;<a href="../std/string.md#std_string_String">std::string::String</a>, <a href="../std/string.md#std_string_String">std::string::String</a>&gt;
</code></pre>
...
<pre><code><b>fun</b> create_internalT(ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): <a href="../iota/display.md#iota_display_Display">iota::display::Display</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>fun</b> add_internalT(<a href="../iota/display.md#iota_display">display</a>: &<b>mut</b> <a href="../iota/display.md#iota_display_Display">iota::display::Display</a>&lt;T&gt;, name: <a href="../std/string.md#std_string_String">std::string::String</a>, value: <a href="../std/string.md#std_string_String">std::string::String</a>)
</code></pre>
