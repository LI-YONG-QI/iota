...
<pre><code><b>public</b> <b>fun</b> newK, V(ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): <a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> addK, V(<a href="../iota/table.md#iota_table">table</a>: &<b>mut</b> <a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;, k: K, v: V)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> borrowK, V(<a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;, k: K): &V
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> borrow_mutK, V(<a href="../iota/table.md#iota_table">table</a>: &<b>mut</b> <a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;, k: K): &<b>mut</b> V
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> removeK, V(<a href="../iota/table.md#iota_table">table</a>: &<b>mut</b> <a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;, k: K): V
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> containsK, V(<a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;, k: K): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> lengthK, V(<a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;): u64
</code></pre>
...
Returns true iff the table is empty (if <code><a href="../iota/object_table.md#iota_object_table_length">length</a></code> returns <code>0</code>)


<pre><code><b>public</b> <b>fun</b> is_emptyK, V(<a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> destroy_emptyK, V(<a href="../iota/table.md#iota_table">table</a>: <a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> value_idK, V(<a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/object_table.md#iota_object_table_ObjectTable">iota::object_table::ObjectTable</a>&lt;K, V&gt;, k: K): <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;<a href="../iota/object.md#iota_object_ID">iota::object::ID</a>&gt;
</code></pre>
