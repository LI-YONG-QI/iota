...
<pre><code><b>entry</b> <b>fun</b> defaultT(pub: &<a href="../iota/package.md#iota_package_Publisher">iota::package::Publisher</a>, ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> withdrawT(self: &<b>mut</b> <a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;, cap: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicyCap">iota::transfer_policy::TransferPolicyCap</a>&lt;T&gt;, amount: <a href="../std/option.md#std_option_Option">std::option::Option</a>&lt;u64&gt;, ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): <a href="../iota/coin.md#iota_coin_Coin">iota::coin::Coin</a>&lt;<a href="../iota/iota.md#iota_iota_IOTA">iota::iota::IOTA</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> destroy_and_withdrawT(self: <a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;, cap: <a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicyCap">iota::transfer_policy::TransferPolicyCap</a>&lt;T&gt;, ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): <a href="../iota/coin.md#iota_coin_Coin">iota::coin::Coin</a>&lt;<a href="../iota/iota.md#iota_iota_IOTA">iota::iota::IOTA</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> add_ruleT, Rule, Config(_: Rule, policy: &<b>mut</b> <a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;, cap: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicyCap">iota::transfer_policy::TransferPolicyCap</a>&lt;T&gt;, cfg: Config)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> get_ruleT, Rule, Config(_: Rule, policy: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;): &Config
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> add_to_balanceT, Rule(_: Rule, policy: &<b>mut</b> <a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;, <a href="../iota/coin.md#iota_coin">coin</a>: <a href="../iota/coin.md#iota_coin_Coin">iota::coin::Coin</a>&lt;<a href="../iota/iota.md#iota_iota_IOTA">iota::iota::IOTA</a>&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> add_receiptT, Rule(_: Rule, request: &<b>mut</b> <a href="../iota/transfer_policy.md#iota_transfer_policy_TransferRequest">iota::transfer_policy::TransferRequest</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> has_ruleT, Rule(policy: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> remove_ruleT, Rule, Config(policy: &<b>mut</b> <a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;, cap: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicyCap">iota::transfer_policy::TransferPolicyCap</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> uidT(self: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;): &<a href="../iota/object.md#iota_object_UID">iota::object::UID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> uid_mut_as_ownerT(self: &<b>mut</b> <a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;, cap: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicyCap">iota::transfer_policy::TransferPolicyCap</a>&lt;T&gt;): &<b>mut</b> <a href="../iota/object.md#iota_object_UID">iota::object::UID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> rulesT(self: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;): &<a href="../iota/vec_set.md#iota_vec_set_VecSet">iota::vec_set::VecSet</a>&lt;<a href="../std/type_name.md#std_type_name_TypeName">std::type_name::TypeName</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> itemT(self: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferRequest">iota::transfer_policy::TransferRequest</a>&lt;T&gt;): <a href="../iota/object.md#iota_object_ID">iota::object::ID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> paidT(self: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferRequest">iota::transfer_policy::TransferRequest</a>&lt;T&gt;): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> fromT(self: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferRequest">iota::transfer_policy::TransferRequest</a>&lt;T&gt;): <a href="../iota/object.md#iota_object_ID">iota::object::ID</a>
</code></pre>
