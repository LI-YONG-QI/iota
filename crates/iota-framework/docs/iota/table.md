...
<pre><code><b>public</b> <b>fun</b> newK, V(ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): <a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> addK, V(<a href="../iota/table.md#iota_table">table</a>: &<b>mut</b> <a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;, k: K, v: V)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> borrowK, V(<a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;, k: K): &V
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> borrow_mutK, V(<a href="../iota/table.md#iota_table">table</a>: &<b>mut</b> <a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;, k: K): &<b>mut</b> V
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> removeK, V(<a href="../iota/table.md#iota_table">table</a>: &<b>mut</b> <a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;, k: K): V
</code></pre>
...
Returns true iff there is a value associated with the key <code>k: K</code> in table <code><a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/table.md#iota_table_Table">Table</a>&lt;K, V&gt;</code>


<pre><code><b>public</b> <b>fun</b> containsK, V(<a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;, k: K): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> lengthK, V(<a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;): u64
</code></pre>
...
Returns true iff the table is empty (if <code><a href="../iota/table.md#iota_table_length">length</a></code> returns <code>0</code>)


<pre><code><b>public</b> <b>fun</b> is_emptyK, V(<a href="../iota/table.md#iota_table">table</a>: &<a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> destroy_emptyK, V(<a href="../iota/table.md#iota_table">table</a>: <a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> dropK, V(<a href="../iota/table.md#iota_table">table</a>: <a href="../iota/table.md#iota_table_Table">iota::table::Table</a>&lt;K, V&gt;)
</code></pre>
