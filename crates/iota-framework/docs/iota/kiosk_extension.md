...
<pre><code><b>public</b> <b>fun</b> addExt(_ext: Ext, self: &<b>mut</b> <a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>, cap: &<a href="../iota/kiosk.md#iota_kiosk_KioskOwnerCap">iota::kiosk::KioskOwnerCap</a>, permissions: u128, ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> disableExt(self: &<b>mut</b> <a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>, cap: &<a href="../iota/kiosk.md#iota_kiosk_KioskOwnerCap">iota::kiosk::KioskOwnerCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> enableExt(self: &<b>mut</b> <a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>, cap: &<a href="../iota/kiosk.md#iota_kiosk_KioskOwnerCap">iota::kiosk::KioskOwnerCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> removeExt(self: &<b>mut</b> <a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>, cap: &<a href="../iota/kiosk.md#iota_kiosk_KioskOwnerCap">iota::kiosk::KioskOwnerCap</a>)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> storageExt(_ext: Ext, self: &<a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>): &<a href="../iota/bag.md#iota_bag_Bag">iota::bag::Bag</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> storage_mutExt(_ext: Ext, self: &<b>mut</b> <a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>): &<b>mut</b> <a href="../iota/bag.md#iota_bag_Bag">iota::bag::Bag</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> placeExt, T(_ext: Ext, self: &<b>mut</b> <a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>, item: T, _policy: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> lockExt, T(_ext: Ext, self: &<b>mut</b> <a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>, item: T, _policy: &<a href="../iota/transfer_policy.md#iota_transfer_policy_TransferPolicy">iota::transfer_policy::TransferPolicy</a>&lt;T&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> is_installedExt(self: &<a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> is_enabledExt(self: &<a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> can_placeExt(self: &<a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>): bool
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> can_lockExt(self: &<a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>): bool
</code></pre>
...
<pre><code><b>fun</b> extensionExt(self: &<a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>): &<a href="../iota/kiosk_extension.md#iota_kiosk_extension_Extension">iota::kiosk_extension::Extension</a>
</code></pre>
...
<pre><code><b>fun</b> extension_mutExt(self: &<b>mut</b> <a href="../iota/kiosk.md#iota_kiosk_Kiosk">iota::kiosk::Kiosk</a>): &<b>mut</b> <a href="../iota/kiosk_extension.md#iota_kiosk_extension_Extension">iota::kiosk_extension::Extension</a>
</code></pre>
