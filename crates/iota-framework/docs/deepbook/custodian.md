...
<pre><code><b>public</b> <b>fun</b> <a href="../deepbook/custodian.md#deepbook_custodian_mint_account_cap">mint_account_cap</a>(ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): <a href="../deepbook/custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> account_balanceAsset(<a href="../deepbook/custodian.md#deepbook_custodian">custodian</a>: &<a href="../deepbook/custodian.md#deepbook_custodian_Custodian">deepbook::custodian::Custodian</a>&lt;Asset&gt;, user: <a href="../iota/object.md#iota_object_ID">iota::object::ID</a>): (u64, u64)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> newT(ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): <a href="../deepbook/custodian.md#deepbook_custodian_Custodian">deepbook::custodian::Custodian</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> unlock_balanceT(<a href="../deepbook/custodian.md#deepbook_custodian">custodian</a>: &<b>mut</b> <a href="../deepbook/custodian.md#deepbook_custodian_Custodian">deepbook::custodian::Custodian</a>&lt;T&gt;, user: <a href="../iota/object.md#iota_object_ID">iota::object::ID</a>, quantity: u64)
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> account_available_balanceT(<a href="../deepbook/custodian.md#deepbook_custodian">custodian</a>: &<a href="../deepbook/custodian.md#deepbook_custodian_Custodian">deepbook::custodian::Custodian</a>&lt;T&gt;, user: <a href="../iota/object.md#iota_object_ID">iota::object::ID</a>): u64
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> account_locked_balanceT(<a href="../deepbook/custodian.md#deepbook_custodian">custodian</a>: &<a href="../deepbook/custodian.md#deepbook_custodian_Custodian">deepbook::custodian::Custodian</a>&lt;T&gt;, user: <a href="../iota/object.md#iota_object_ID">iota::object::ID</a>): u64
</code></pre>
