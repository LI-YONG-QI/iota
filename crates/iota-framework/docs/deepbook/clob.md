...
<pre><code><b>public</b> <b>fun</b> create_poolBaseAsset, QuoteAsset(_tick_size: u64, _lot_size: u64, _creation_fee: <a href="../iota/coin.md#iota_coin_Coin">iota::coin::Coin</a>&lt;<a href="../iota/iota.md#iota_iota_IOTA">iota::iota::IOTA</a>&gt;, _ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>)
</code></pre>
...
<pre><code><b>fun</b> match_bid_with_quote_quantityBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="../deepbook/clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, quantity: u64, price_limit: u64, current_timestamp: u64, quote_balance: <a href="../iota/balance.md#iota_balance_Balance">iota::balance::Balance</a>&lt;QuoteAsset&gt;): (<a href="../iota/balance.md#iota_balance_Balance">iota::balance::Balance</a>&lt;BaseAsset&gt;, <a href="../iota/balance.md#iota_balance_Balance">iota::balance::Balance</a>&lt;QuoteAsset&gt;)
</code></pre>
...
<pre><code><b>fun</b> match_askBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="../deepbook/clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price_limit: u64, current_timestamp: u64, base_balance: <a href="../iota/balance.md#iota_balance_Balance">iota::balance::Balance</a>&lt;BaseAsset&gt;): (<a href="../iota/balance.md#iota_balance_Balance">iota::balance::Balance</a>&lt;BaseAsset&gt;, <a href="../iota/balance.md#iota_balance_Balance">iota::balance::Balance</a>&lt;QuoteAsset&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> place_market_orderBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="../deepbook/clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, quantity: u64, is_bid: bool, base_coin: <a href="../iota/coin.md#iota_coin_Coin">iota::coin::Coin</a>&lt;BaseAsset&gt;, quote_coin: <a href="../iota/coin.md#iota_coin_Coin">iota::coin::Coin</a>&lt;QuoteAsset&gt;, clock: &<a href="../iota/clock.md#iota_clock_Clock">iota::clock::Clock</a>, ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): (<a href="../iota/coin.md#iota_coin_Coin">iota::coin::Coin</a>&lt;BaseAsset&gt;, <a href="../iota/coin.md#iota_coin_Coin">iota::coin::Coin</a>&lt;QuoteAsset&gt;)
</code></pre>
...
<pre><code><b>fun</b> inject_limit_orderBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="../deepbook/clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price: u64, quantity: u64, is_bid: bool, expire_timestamp: u64, account_cap: &<a href="../deepbook/custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>, ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> place_limit_orderBaseAsset, QuoteAsset(pool: &<b>mut</b> <a href="../deepbook/clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price: u64, quantity: u64, is_bid: bool, expire_timestamp: u64, restriction: u8, clock: &<a href="../iota/clock.md#iota_clock_Clock">iota::clock::Clock</a>, account_cap: &<a href="../deepbook/custodian.md#deepbook_custodian_AccountCap">deepbook::custodian::AccountCap</a>, ctx: &<b>mut</b> <a href="../iota/tx_context.md#iota_tx_context_TxContext">iota::tx_context::TxContext</a>): (u64, u64, bool, u64)
</code></pre>
...
<pre><code><b>fun</b> emit_order_canceledBaseAsset, QuoteAsset(pool_id: <a href="../iota/object.md#iota_object_ID">iota::object::ID</a>, order: &<a href="../deepbook/clob.md#deepbook_clob_Order">deepbook::clob::Order</a>)
</code></pre>
...
<pre><code><b>fun</b> emit_order_filledBaseAsset, QuoteAsset(pool_id: <a href="../iota/object.md#iota_object_ID">iota::object::ID</a>, order: &<a href="../deepbook/clob.md#deepbook_clob_Order">deepbook::clob::Order</a>, base_asset_quantity_filled: u64, taker_commission: u64, maker_rebates: u64)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> get_level2_book_status_bid_sideBaseAsset, QuoteAsset(pool: &<a href="../deepbook/clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price_low: u64, price_high: u64, clock: &<a href="../iota/clock.md#iota_clock_Clock">iota::clock::Clock</a>): (vector&lt;u64&gt;, vector&lt;u64&gt;)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> get_level2_book_status_ask_sideBaseAsset, QuoteAsset(pool: &<a href="../deepbook/clob.md#deepbook_clob_Pool">deepbook::clob::Pool</a>&lt;BaseAsset, QuoteAsset&gt;, price_low: u64, price_high: u64, clock: &<a href="../iota/clock.md#iota_clock_Clock">iota::clock::Clock</a>): (vector&lt;u64&gt;, vector&lt;u64&gt;)
</code></pre>
