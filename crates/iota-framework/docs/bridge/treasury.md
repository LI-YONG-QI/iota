...
<pre><code><b>public</b>(package) <b>fun</b> burnT(self: &<b>mut</b> <a href="../bridge/treasury.md#bridge_treasury_BridgeTreasury">bridge::treasury::BridgeTreasury</a>, token: <a href="../iota/coin.md#iota_coin_Coin">iota::coin::Coin</a>&lt;T&gt;)
</code></pre>
