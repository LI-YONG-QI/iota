...
fn transform_ingestion_url(ingestion_url: String) -> String {
    ...
    if ingestion_url.contains("checkpoints.mainnet.iota.io") {
        "https://storage.googleapis.com/iota-mainnet-checkpoints".to_string()
    } else if ingestion_url.contains("checkpoints.testnet.iota.io") {
        "https://storage.googleapis.com/iota-testnet-checkpoints".to_string()
    } else {
        ingestion_url
    }
}
