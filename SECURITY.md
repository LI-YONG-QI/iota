...
The program is run in partnership with [HackenProof](https://hackenproof.com/). More information is available on [their site](https://hackenproof.com/iota/iota/).
...
All reports must be sent using HackenProof’s [secure dashboard](https://hackenproof.com/iota/iota/). **DO NOT report a security issue using GitHub, email, or Discord.**
...
_Iota and HackenProof will be conducting Office Hours to answer questions. A date will be announced on Twitter by [@IotaNetwork](https://x.com/iota). If you are not able to attend, you can email questions to info@hackenproof.com._ with questions regarding the Bug Bounty Program.
