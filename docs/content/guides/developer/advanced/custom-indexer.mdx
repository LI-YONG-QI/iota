...
- Testnet: `https://storage.googleapis.com/iota-testnet-checkpoints`
- Mainnet: `https://storage.googleapis.com/iota-mainnet-checkpoints`

The checkpoint files are stored in the following format: `https://storage.googleapis.com/iota-testnet-checkpoints/<checkpoint_id>.chk`. You can download the checkpoint file by sending an HTTP GET request to the relevant URL. Try it yourself for checkpoint 1 at [https://storage.googleapis.com/iota-testnet-checkpoints/1.chk](https://storage.googleapis.com/iota-testnet-checkpoints/1.chk).
...
executor.run(
    ...
    Some("https://storage.googleapis/iota-testnet-checkpoints".to_string()), // Remote Checkpoint Store
