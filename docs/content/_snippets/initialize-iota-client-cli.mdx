...
See [Publish a Package](../developer/getting-started/publish.mdx) for a more detailed guide on publishing packages or [IOTA Client CLI](/developer/cli/client.mdx) for a complete reference of `client` commands in the IOTA CLI.
