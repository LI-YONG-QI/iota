...
IOTA provides the [IOTA command line interface (CLI)](/developer/cli/client.mdx) to interact with [IOTA networks](#iota-networks), it does the following and more:

- Create and manage your private keys
- Call and publish Move modules
- Compile and test Move modules
- Create and execute programmable transaction blocks ([PTBs](/developer/cli/ptb.mdx))
...
the [IOTA CLI Client](../../developer/cli/client.mdx):
...
The [IOTA CLI Client](../../developer/cli/client.mdx) allows you to add any number of network environments.
