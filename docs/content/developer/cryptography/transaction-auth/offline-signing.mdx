...
The following example demonstrates how to serialize data for a transfer using the [IOTA CLI](../../../developer/cli.mdx). This returns serialized transaction data in Base64. Submit the raw transaction to execute as `tx_bytes`.
