...
When you first use the [IOTA CLI](../../../developer/cli.mdx), it creates a keystore at `~/.move/keystore` on your machine, storing your private keys. You can sign transactions using any key by specifying its address. Use `move keytool list` to view your addresses.
