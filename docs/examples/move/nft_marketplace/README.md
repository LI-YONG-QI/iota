...
You can use the following [move-call](https://docs.iota.org/developer/cli/ptb#move-call) to get the royalties for any given product by calling the `kiosk::royalty_rule::fee_amount` function
...
You can use the following command to [split your gas tokens](https://docs.iota.org/developer/cli/ptb#split-destroy-and-merge-coins) to pay for the item's price and royalties:
...
You can use the following [move-call](https://docs.iota.org/developer/cli/ptb#move-call) to pay the owner the item's price.
